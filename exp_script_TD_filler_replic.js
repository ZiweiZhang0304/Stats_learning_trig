...
const sorting_stimuli_stage1_trial2_planA_string_01 = '<br><input name="img1" type= "checkbox" id="img1" position:absolute; right:5px; bottom:3px;> <label for="course"> <img src="' + `${img0}` + '" /></label> <input name="img2" type= "checkbox" id="img2" position:absolute; right:5px; bottom:3px;> <label for="course"> <img src="' + `${img1}` + '" /> <input name="img3" type= "checkbox" id="img3" position:absolute; right:5px; bottom:3px;> <label for="course"> <img src="' + `${img2}` + '" /> <input name="img4" type= "checkbox" id="img4" position:absolute; right:5px; bottom:3px;> <label for="course"> <img src="' + `${img3}` + '" /> <input name="img5" type= "checkbox" id="img5" position:absolute; right:5px; bottom:3px;> <label for="course"> <img src="' + `${img4}` + '" /> <input name="img6" type= "checkbox" id="img6"> <label for="course"> <img src="' + `${img5}` + '" /> <input name="img7" type= "checkbox" id="img7" > <label for="course"> <img src="' + `${img6}` + '" /> '
