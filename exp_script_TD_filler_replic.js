...
const sorting_stimuli_stage1_trial2_planA_string_01 = '<br><input name="img1" type= "checkbox" id="img1" style= "position:relative; right:300px; bottom:200px; margin-left: 1em;  margin-right: 1em;"> <label for="course"> <img src="' + `${img0}` + '" /></label> <input name="img2" type= "checkbox" id="img2" style= "position:absolute; right:500px; bottom:300px;"> <label for="course"> <img src="' + `${img1}` + '" /> <input name="img3" type= "checkbox" id="img3" style= "position:fixed; right:480px; bottom:300px;"> <label for="course"> <img src="' + `${img2}` + '" /> <input name="img4" type= "checkbox" id="img4" style= "position:absolute; right:5px; bottom:3px;"> <label for="course"> <img src="' + `${img3}` + '" /> <input name="img5" type= "checkbox" id="img5" style= "position:absolute; right:5px; bottom:3px;"> <label for="course"> <img src="' + `${img4}`
+ '" /> <input name="img6" type= "checkbox" id="img6" style= "margin-left: 10em;  margin-right: 1em;"> <label for="course"> <img src="' + `${img5}`
+ '" /> <input name="img7" type= "checkbox" id="img7" style= "position:absolute; right:5px; bottom:3px;"> <label for="course"> <img src="' + `${img6}` + '" /> '
