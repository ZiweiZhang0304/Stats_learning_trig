...
'<p> <center> Please select <b>ANOTHER</b> 3 shapes that always occurred together one after another in the same order in the first part of the study. <br> Click on the checkbox to select and unselect. <br> You must select exactly 3 shapes to move on. </center></p> <br><br><br>   <input name="img01" type= "checkbox" id="img01" style= "margin-left: 6em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: middle;" src="' + `${img26}`
+ '" /> <input name="img02" type= "checkbox" id="img02" style= "margin-left: 6em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: middle;" src="' + `${img27}`
+ '" /> <input name="img02" type= "checkbox" id="img02" style= "margin-left: 6em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: middle;" src="' + `${img28}`
+ '" /> <input name="img03" type= "checkbox" id="img03" style= "margin-left: 6em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: middle;" src="' + `${img29}`
+ '" /> <input name="img04" type= "checkbox" id="img04" style= "margin-left: 6em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: middle;" src="' + `${img30}`
+ '" /> <input name="img05" type= "checkbox" id="img05" style= "margin-left: 6em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: middle;" src="' + `${img31}`
+ '" /> <input name="img06" type= "checkbox" id="img06" style= "margin-left: 6em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: middle;" src="' + `${img32}`
+ '" /> <input name="img07" type= "checkbox" id="img07" style= "margin-left: 6em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: middle;" src="' + `${img33}` + '" /> '

const sorting_stimuli_stage1_trial2_planC_string_02 =
'       <input name="img08" type= "checkbox" id="img08" style= "margin-left: 6em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: middle;" src="' + `${img34}`
+ '" /> <input name="img09" type= "checkbox" id="img09" style= "margin-left: 6em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: middle;" src="' + `${img35}`
+ '" /> <input name="img10" type= "checkbox" id="img10" style= "margin-left: 6em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: middle;" src="' + `${img36}`
+ '" /> <input name="img11" type= "checkbox" id="img11" style= "margin-left: 6em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: middle;" src="' + `${img37}`
+ '" /> <input name="img12" type= "checkbox" id="img12" style= "margin-left: 6em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: middle;" src="' + `${img38}`+ '" />'

const sorting_stimuli_stage1_trial2_planC_string_03 =
'       <input name="img13" type= "checkbox" id="img13" style= "margin-left: 6em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: middle;" src="' + `${img39}`
+ '" /> <input name="img14" type= "checkbox" id="img14" style= "margin-left: 6em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: middle;" src="' + `${img40}`
+ '" /> <input name="img15" type= "checkbox" id="img15" style= "margin-left: 6em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: middle;" src="' + `${img41}`
+ '" /> <input name="img16" type= "checkbox" id="img16" style= "margin-left: 6em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: middle;" src="' + `${img42}`
+ '" /> <input name="img17" type= "checkbox" id="img17" style= "margin-left: 6em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: middle;" src="' + `${img43}`
+ '" /> <input name="img18" type= "checkbox" id="img18" style= "margin-left: 6em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: middle;" src="' + `${img44}`
+ '" /> <input name="img19" type= "checkbox" id="img19" style= "margin-left: 6em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: middle;" src="' + `${img45}`
+ '" /> <input name="img20" type= "checkbox" id="img20" style= "margin-left: 6em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: middle;" src="' + `${img46}`
+ '" /> <input name="img21" type= "checkbox" id="img21" style= "margin-left: 6em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: middle;" src="' + `${img47}`
+ '" /> <input name="img22" type= "checkbox" id="img22" style= "margin-left: 6em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: middle;" src="' + `${img48}`
+ '" /> <input name="img23" type= "checkbox" id="img23" style= "margin-left: 6em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: middle;" src="' + `${img49}`
+ '" /> <input name="img24" type= "checkbox" id="img24" style= "margin-left: 6em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: middle;" src="' + `${img50}`
+ '" /> <input name="img25" type= "checkbox" id="img25" style= "margin-left: 6em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: middle;" src="' + `${img51}` + '" /> <br><br>'
...
timeline.push(enter_full, instruction6, sort_trial_stage1_trial1_planC, sort_trial_stage1_trial2_planC)
