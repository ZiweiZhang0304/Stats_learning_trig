...
'<p> <center> Please select 3 shapes that always occurred together one after another in the same order in the first part of the study. <br> Click on the checkbox to select and unselect. <br> You must select exactly 3 shapes to move on. </center></p> <br><br><br>   <input name="img01" type= "checkbox" id="img01" style= "margin-left: 4em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: baseline;" src="' + `${img0}`
+ '" /> <input name="img02" type= "checkbox" id="img02" style= "margin-left: 4em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: baseline;" src="' + `${img1}`
+ '" /> <input name="img02" type= "checkbox" id="img02" style= "margin-left: 4em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: baseline;" src="' + `${img2}`
...
+ '" /> <input name="img25" type= "checkbox" id="img25" style= "margin-left: 3em;  margin-right: 0em; margin-top: 2em;"> <label for="course"> <img style= "margin-left: 0em;  margin-right: 1em; margin-top: 2em; vertical-align: middle;" src="' + `${img51}` + '" /> <br><br>'
