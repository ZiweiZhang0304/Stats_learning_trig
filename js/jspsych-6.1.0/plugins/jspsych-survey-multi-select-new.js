...
jsPsych.plugins['survey-multi-select'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var cssstr = ".jspsych-survey-multi-select-question { margin-top: 2em; margin-bottom: 2em; text-align: left; }"+
      ".jspsych-survey-multi-select-text span.required {color: transparent;}"+
    ...
    trial_form.addEventListener('submit', function(event) {
      ...
      for(var index=0; index<trial.questions.length; index++){
        ...
        console.log(Array.from(question_data['Q0'][0].id))
        console.log(Array.from(question_data['Q0'][0]['id']))
        console.log(Array.from(question_data['Q0'])[0], typeof Array.from(question_data['Q0'])[0])
        console.log([question_data['Q0'][0].id.toString(),question_data['Q0'][1].id.toString(),question_data['Q0'][2].id.toString()])
      }

      // save data
      var trial_data = {
        "rt": response_time,
        "responses": [question_data['Q0'][0].id.toString(),question_data['Q0'][1].id.toString(),question_data['Q0'][2].id.toString()],
